...
möglich macht. Es genügt, die Festplatte anzuschließen und das Programm zu
starten – ButterBackup erledigt den Rest.

## Schnellstart

```bash
pipx install butter-backup
butter-backup backup --config ~/.config/butter-backup.json
```
